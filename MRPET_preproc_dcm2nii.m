...
filetypes_PET = {'PET-Task-MoCo*T0*_AC_';'PET-Task-MoCo*T300_*_AC_';'PET-Task-MoCo*T600*_AC_';'PET-Task-MoCo*T900*_AC_';...
    ...
    'PET-InFlow_HD';'PET-Baseline_HD'};
seriesnum     = numel(~isnan(cell2mat(strfind(filetypes_PET,'Task')))); % see how many binned PET data there are
    ...
    for d = 1:2
        ...
        if days(id,d) == 0
            ...
            for frames = 1:seriesnum
                flist_PET{frames,1} = [paths.MT num2str(IDs(id)) '_' num2str(d) '/' ...
                    num2str(IDs(id)) '_PET_3D_T' num2str((seriesnum-1)*binsize) '_MT' num2str(d) '.nii,1'];
            end
