...
paths.analyses= [paths.parent 'E_data/EB_cleaned/EBD_mrpet/RewardTask/MRI/bothSessions/'];
...
for id = 10:length(IDs)
    ...
    physiodata1  = R(:,1:18);
    elseif IDs(id)==4012 % no pulse data
    ...
    physiodata2  = importdata(physioFile1);
...
path_source      ='/Users/yeojin/Desktop/E_data/EB_cleaned/EBD_mrpet/RewardTask/MRI/physio_corrected/';
path_destination ='/Users/yeojin/Desktop/E_data/ED_coreg/mrpet/';
...
for id=1:length(IDs)
    ...
    for d = 1:2
        if days(id,d) == 0
            ...
            copyfile([path_source num2str(IDs(id)) '_' num2str(d) '/mask.nii'],...
...
paths.analyses= [paths.parent 'E_data/EB_cleaned/EBD_mrpet/RewardTask/MRI/physio_corrected/'];
paths.behav   = [paths.parent 'E_data/EA_raw/EAC_behav/MRPET/'];

paths.temp    = [paths.parent 'E_data/EB_cleaned/EBD_mrpet/RewardTask/MRI/'];
paths.save2nd = [paths.parent 'E_data/EB_cleaned/EBD_mrpet/RewardTask/MRI/physio_corrected/2ndLvL/'];
...
days = [1 2; 1 2; 1 0; 1 2; 1 2; 0 2; 1 0; 1 2; 0 2; 1 2; 1 2; 1 2; 1 2; 0 2; 1 2; 1 2; 1 2; 1 2; 1 2; 1 0; 1 2; 1 2; 0 2; 1 0; 1 0; 0 2]; 
