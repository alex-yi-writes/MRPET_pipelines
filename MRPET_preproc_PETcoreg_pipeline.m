...
%             for v1=1:numvol
%                 list_bsl{v1,1} = [path_parent num2str(IDs(id)) '_' num2str(d) '/' num2str(IDs(id)) '_PET_4D_MT' num2str(d) '.nii,' num2str(v1)];
%             end
%             
%             clear matlabbatch
%             spm_jobman('initcfg')
...
for id = 6%1:length(IDs)
    ...
    for d = 1:2
        ...
        if days(id,d) == 0
            ...
            TACDATA.info = 'inFlow';
            mkdir(['/Users/yeojin/Desktop/E_data/EA_raw/EAD_PET/EADC_TACs/RewardTask_ANTscoreg/' num2str(IDs(id)) num2str(d)])
            save([ '/Users/yeojin/Desktop/E_data/EA_raw/EAD_PET/EADC_TACs/RewardTask_ANTscoreg/' num2str(IDs(id)) num2str(d) '/' num2str(IDs(id)) num2str(d) '_TACDATA_InFlow.mat'],'TACDATA'); clear TACDATA DynPET temp ImgData            
        end
    end
end
...
for id = 1:length(IDs)
    ...
    for d = 1:2
        ...
        if days(id,d) == 0
            ...
            save([ '/Users/yeojin/Desktop/E_data/EA_raw/EAD_PET/EADC_TACs/RewardTask_ANTscoreg/' num2str(IDs(id)) num2str(d) '/' num2str(IDs(id)) num2str(d) '_TACDATA_Task.mat'],'TACDATA'); clear TACDATA DynPET temp ImgData
...
%             save([ paths.TACs num2str(IDs(id)) num2str(d) '_TACDATA_InFlow.mat'],'TACDATA'); clear TACDATA DynPET temp ImgData
            ...
            save([ '/Users/yeojin/Desktop/E_data/EA_raw/EAD_PET/EADC_TACs/RewardTask_ANTscoreg/' num2str(IDs(id)) num2str(d) '/' num2str(IDs(id)) num2str(d) '_TACDATA_Baseline.mat'],'TACDATA'); clear TACDATA DynPET temp ImgData
        end
    end
end
...
for id = 6%1:length(IDs)
    ...
    for d = 1:2
        ...
        if days(id,d) == 0
            ...
            load([ '/Users/yeojin/Desktop/E_data/EA_raw/EAD_PET/EADC_TACs/RewardTask_ANTscoreg/' num2str(IDs(id)) num2str(d) '/' num2str(IDs(id)) num2str(d) '_TACDATA_InFlow.mat']);
            TACDATA_InFlow=TACDATA; clear TACDATA
            load([ '/Users/yeojin/Desktop/E_data/EA_raw/EAD_PET/EADC_TACs/RewardTask_ANTscoreg/' num2str(IDs(id)) num2str(d) '/' num2str(IDs(id)) num2str(d) '_TACDATA_Baseline.mat']);
            TACDATA_Baseline=TACDATA; clear TACDATA
            load([ '/Users/yeojin/Desktop/E_data/EA_raw/EAD_PET/EADC_TACs/RewardTask_ANTscoreg/' num2str(IDs(id)) num2str(d) '/' num2str(IDs(id)) num2str(d) '_TACDATA_Task.mat']);
            ...
            save(['/Users/yeojin/Desktop/E_data/EA_raw/EAD_PET/EADC_TACs/RewardTask_ANTscoreg/' num2str(IDs(id)) num2str(d) '/' num2str(IDs(id)) num2str(d) '_TACs_deccorr.mat'],'TACDATA_Baseline','TACDATA_InFlow','TACDATA_Task');
            ...
            try
                ...
                legend('Cerebellum','Putamen','Caudate');
                ax = gca; ax.YAxis.Exponent = 0;
                print('-dpdf','-bestfit',[ num2str(IDs(id)) num2str(d) '_20211122.pdf']);
