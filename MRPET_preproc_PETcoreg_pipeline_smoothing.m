%% new PET registrations, smoothe for denoising
...
% set env
path_parent = '/Volumes/ALEX3/MRPET/img/';
path_ROIs   = '/Volumes/ALEX3/MRPET/coreg_roi/';
...
%         else
%             
%             file_name=['coreg_s3_MT' num2str(d) '_on_T1.nii'];
%             folder_path = [path_parent num2str(IDs(id)) '_' num2str(d)  '/coreg_s3_MT' num2str(d) '_on_T1.nii'];
%             
%             if exist(folder_path, 'file') == 2
%                 fprintf('File "%s" exists in folder "%s".\n', file_name, [num2str(IDs(id)) '_' num2str(d)]);
%             else
%                 fprintf('File "%s" does not exist in folder "%s".\n', file_name, [num2str(IDs(id))  '_' num2str(d)]);
%             end
%             
%         end
%     end
...
%             spm_jobman('run',matlabbatch)
            ...
            for v1=10:numvol
                list_inflow{v1-9,1} = [path_parent num2str(IDs(id)) '_' num2str(d) '/r' num2str(IDs(id)) '_PET_4D_InFlow' num2str(d) '.nii,' num2str(v1)];
            end
            ...
            % -------- make mean smoothed image ------- %

            list_inflow=[]; clear numvol
            numvol = length(spm_vol([path_parent num2str(IDs(id)) '_' num2str(d) '/s3r' num2str(IDs(id)) '_PET_4D_InFlow' num2str(d) '.nii']));
            for v1=10:numvol
                list_inflow{v1-9,1} = [path_parent num2str(IDs(id)) '_' num2str(d) '/s3r' num2str(IDs(id)) '_PET_4D_InFlow' num2str(d) '.nii,' num2str(v1)];
            end
            clear matlabbatch
            spm_jobman('initcfg')
            matlabbatch{1}.spm.spatial.realign.write.data = list_inflow;
            ...
            matlabbatch{1}.spm.spatial.realign.write.roptions.prefix = 'm';
            spm_jobman('run',matlabbatch)
            ...
            clear matlabbatch
            spm_jobman('initcfg')
            matlabbatch{1}.spm.util.split.vol = {[path_parent num2str(IDs(id)) '_' num2str(d) '/s3r' num2str(IDs(id)) '_PET_4D_InFlow' num2str(d) '.nii']};
            matlabbatch{1}.spm.util.split.outdir = {[path_parent num2str(IDs(id)) '_' num2str(d) '/inflow3D']};
            spm_jobman('run',matlabbatch)

            
            % register meanPET to T1
            eval(['!antsRegistrationSyN.sh -d 3 -t r -m ' path_parent num2str(IDs(id)) '_' num2str(d) '/means3r' num2str(IDs(id)) '_PET_4D_InFlow' num2str(d) '.nii -f '...
                path_parent num2str(IDs(id)) '_' num2str(d) '/' num2str(IDs(id)) '_MRI_4D_MPRAGE' num2str(d) '_pt1.nii -o ' path_parent num2str(IDs(id)) '_' num2str(d)  '/coreg_s3_InFlowtoT1pt1_' ])
            % apply transformations to the images
            numvol = length(spm_vol([path_parent num2str(IDs(id)) '_' num2str(d) '/s3r' num2str(IDs(id)) '_PET_4D_InFlow' num2str(d) '.nii']));
            for v2=1:numvol
                eval(['!antsApplyTransforms -d 3 -v 0 -n Linear -t ' path_parent num2str(IDs(id)) '_' num2str(d)  '/coreg_s3_InFlowtoT1pt1_0GenericAffine.mat -i '...
                    path_parent num2str(IDs(id)) '_' num2str(d) '/inflow3D/s3r' num2str(IDs(id)) '_PET_4D_InFlow' num2str(d) '_' sprintf('%05i',v2) '.nii -r '...
                    path_parent num2str(IDs(id)) '_' num2str(d) '/' num2str(IDs(id)) '_MRI_4D_MPRAGE' num2str(d) '_pt1.nii -o ' path_parent num2str(IDs(id)) '_' num2str(d)  '/inflow3D/coreg_s3_InFlow' num2str(d) '_on_T1_' sprintf('%05i',v2) '.nii'])
            end
            ...
            numvol = length(spm_vol([path_parent num2str(IDs(id)) '_' num2str(d) '/s3r' num2str(IDs(id)) '_PET_4D_InFlow' num2str(d) '.nii']));
            for v1=1:numvol
                list_inflow{v1,1} = [path_parent num2str(IDs(id)) '_' num2str(d)  '/inflow3D/coreg_s3_InFlow' num2str(d) '_on_T1_' sprintf('%05i',v1) '.nii,1'];
            end
            clear matlabbatch
            spm_jobman('initcfg')
            matlabbatch{1}.spm.util.cat.vols = list_inflow;
            matlabbatch{1}.spm.util.cat.name = ['coreg_s3_InFlow' num2str(d) '_on_T1.nii'];
            matlabbatch{1}.spm.util.cat.dtype = 4;
            spm_jobman('run',matlabbatch)
            
            movefile([path_parent num2str(IDs(id)) '_' num2str(d)  '/inflow3D/coreg_s3_InFlow' num2str(d) '_on_T1.nii'],...
                [path_parent num2str(IDs(id)) '_' num2str(d)  '/coreg_s3_InFlow' num2str(d) '_on_T1.nii'])
...
%             spm_jobman('run',matlabbatch)
            ...
            list_bsl=[];
            numvol = length(spm_vol([path_parent num2str(IDs(id)) '_' num2str(d) '/r' num2str(IDs(id)) '_PET_4D_Baseline' num2str(d) '.nii']));
            for v1=1:numvol
                list_bsl{v1,1} = [path_parent num2str(IDs(id)) '_' num2str(d) '/r' num2str(IDs(id)) '_PET_4D_Baseline' num2str(d) '.nii,' num2str(v1)];
            end
%           
            clear matlabbatch
            spm_jobman('initcfg')
            matlabbatch{1}.spm.spatial.smooth.data = list_bsl;
            matlabbatch{1}.spm.spatial.smooth.fwhm = [3 3 3];
            matlabbatch{1}.spm.spatial.smooth.dtype = 0;
            matlabbatch{1}.spm.spatial.smooth.im = 0;
            matlabbatch{1}.spm.spatial.smooth.prefix = 's3';
            ...
            numvol = length(spm_vol([path_parent num2str(IDs(id)) '_' num2str(d) '/s3r' num2str(IDs(id)) '_PET_4D_Baseline' num2str(d) '.nii']));
            for v1=1:numvol
                list_bsl{v1,1} = [path_parent num2str(IDs(id)) '_' num2str(d) '/s3r' num2str(IDs(id)) '_PET_4D_Baseline' num2str(d) '.nii,' num2str(v1)];
            end
            clear matlabbatch
            spm_jobman('initcfg')
            matlabbatch{1}.spm.spatial.realign.write.data = list_bsl;
            matlabbatch{1}.spm.spatial.realign.write.roptions.which = [0 1];
            matlabbatch{1}.spm.spatial.realign.write.roptions.interp = 4;
            matlabbatch{1}.spm.spatial.realign.write.roptions.wrap = [0 0 0];
            matlabbatch{1}.spm.spatial.realign.write.roptions.mask = 1;
            ...
            clear matlabbatch
            spm_jobman('initcfg')
            matlabbatch{1}.spm.util.split.vol = {[path_parent num2str(IDs(id)) '_' num2str(d) '/s3r' num2str(IDs(id)) '_PET_4D_Baseline' num2str(d) '.nii']};
            matlabbatch{1}.spm.util.split.outdir = {[path_parent num2str(IDs(id)) '_' num2str(d) '/bsl3D']};
            spm_jobman('run',matlabbatch)
            
            % register meanPET to T1
            eval(['!antsRegistrationSyN.sh -d 3 -t r -m ' path_parent num2str(IDs(id)) '_' num2str(d) '/means3r' num2str(IDs(id)) '_PET_4D_Baseline' num2str(d) '.nii -f '...
                path_parent num2str(IDs(id)) '_' num2str(d) '/' num2str(IDs(id)) '_MRI_4D_MPRAGE' num2str(d) '_pt2.nii -o ' path_parent num2str(IDs(id)) '_' num2str(d)  '/coreg_s3_BaselinetoT1pt2_' ])
            % apply transformations to the images
            for v2=1:numvol
                eval(['!antsApplyTransforms -d 3 -v 0 -n Linear -t ' path_parent num2str(IDs(id)) '_' num2str(d)  '/coreg_s3_BaselinetoT1pt2_0GenericAffine.mat -i '...
                    path_parent num2str(IDs(id)) '_' num2str(d) '/bsl3D/s3r' num2str(IDs(id)) '_PET_4D_Baseline' num2str(d) '_' sprintf('%05i',v2) '.nii -r '...
                    path_parent num2str(IDs(id)) '_' num2str(d) '/' num2str(IDs(id)) '_MRI_4D_MPRAGE' num2str(d) '_pt2.nii -o ' path_parent num2str(IDs(id)) '_' num2str(d)  '/bsl3D/coreg_s3_Baseline' num2str(d) '_on_T1_' sprintf('%05i',v2) '.nii'])
            end
            
            % assemble again
            list_bsl=[];
            for v1=1:numvol
                list_bsl{v1,1} = [path_parent num2str(IDs(id)) '_' num2str(d)  '/bsl3D/coreg_s3_Baseline' num2str(d) '_on_T1_' sprintf('%05i',v1) '.nii,1'];
            end
            clear matlabbatch
            spm_jobman('initcfg')
            matlabbatch{1}.spm.util.cat.vols = list_bsl;
            matlabbatch{1}.spm.util.cat.name = ['coreg_s3_Baseline' num2str(d) '_on_T1.nii'];
            matlabbatch{1}.spm.util.cat.dtype = 4;
            spm_jobman('run',matlabbatch)
            
            movefile([path_parent num2str(IDs(id)) '_' num2str(d)  '/bsl3D/coreg_s3_Baseline' num2str(d) '_on_T1.nii'],...
                [path_parent num2str(IDs(id)) '_' num2str(d)  '/coreg_s3_Baseline' num2str(d) '_on_T1.nii'])
...
%             spm_jobman('run',matlabbatch)
            ...
            list_task=[];
            numvol = length(spm_vol([path_parent num2str(IDs(id)) '_' num2str(d) '/r' num2str(IDs(id)) '_PET_4D_MT' num2str(d) '.nii']));
            for v1=1:numvol
                list_task{v1,1} = [path_parent num2str(IDs(id)) '_' num2str(d) '/r' num2str(IDs(id)) '_PET_4D_MT' num2str(d) '.nii,' num2str(v1)];
            end
            clear matlabbatch
            spm_jobman('initcfg')
            matlabbatch{1}.spm.spatial.smooth.data = list_task;
            matlabbatch{1}.spm.spatial.smooth.fwhm = [3 3 3];
            matlabbatch{1}.spm.spatial.smooth.dtype = 0;
            matlabbatch{1}.spm.spatial.smooth.im = 0;
            matlabbatch{1}.spm.spatial.smooth.prefix = 's3';
            ...
            list_task=[];
            numvol = length(spm_vol([path_parent num2str(IDs(id)) '_' num2str(d) '/s3r' num2str(IDs(id)) '_PET_4D_MT' num2str(d) '.nii']));
            for v1=1:numvol
                list_task{v1,1} = [path_parent num2str(IDs(id)) '_' num2str(d) '/s3r' num2str(IDs(id)) '_PET_4D_MT' num2str(d) '.nii,' num2str(v1)];
            end
            clear matlabbatch
            spm_jobman('initcfg')
            matlabbatch{1}.spm.spatial.realign.write.data = list_task;
            matlabbatch{1}.spm.spatial.realign.write.roptions.which = [0 1];
            matlabbatch{1}.spm.spatial.realign.write.roptions.interp = 4;
            matlabbatch{1}.spm.spatial.realign.write.roptions.wrap = [0 0 0];
            matlabbatch{1}.spm.spatial.realign.write.roptions.mask = 1;
            ...
            clear matlabbatch
            spm_jobman('initcfg')
            matlabbatch{1}.spm.util.split.vol = {[path_parent num2str(IDs(id)) '_' num2str(d) '/s3r' num2str(IDs(id)) '_PET_4D_MT' num2str(d) '.nii']};
            matlabbatch{1}.spm.util.split.outdir = {[path_parent num2str(IDs(id)) '_' num2str(d) '/task3D']};
            spm_jobman('run',matlabbatch)
            
            % register meanPET to T1
            eval(['!antsRegistrationSyN.sh -d 3 -t r -m ' path_parent num2str(IDs(id)) '_' num2str(d) '/means3r' num2str(IDs(id)) '_PET_4D_MT' num2str(d) '.nii -f '...
                path_parent num2str(IDs(id)) '_' num2str(d) '/' num2str(IDs(id)) '_MRI_4D_MPRAGE' num2str(d) '_pt2.nii -o ' path_parent num2str(IDs(id)) '_' num2str(d)  '/coreg_s3_MTtoT1pt2_' ])
            % apply transformations to the images
            for v2=1:numvol
                eval(['!antsApplyTransforms -d 3 -v 0 -n Linear -t ' path_parent num2str(IDs(id)) '_' num2str(d)  '/coreg_s3_MTtoT1pt2_0GenericAffine.mat -i '...
                    path_parent num2str(IDs(id)) '_' num2str(d) '/task3D/s3r' num2str(IDs(id)) '_PET_4D_MT' num2str(d) '_' sprintf('%05i',v2) '.nii -r '...
                    path_parent num2str(IDs(id)) '_' num2str(d) '/' num2str(IDs(id)) '_MRI_4D_MPRAGE' num2str(d) '_pt2.nii -o ' path_parent num2str(IDs(id)) '_' num2str(d)  '/task3D/coreg_s3_MT' num2str(d) '_on_T1_' sprintf('%05i',v2) '.nii'])
            end
            
            % assemble again
            list_task=[];
            for v1=1:numvol
                list_task{v1,1} = [path_parent num2str(IDs(id)) '_' num2str(d)  '/task3D/coreg_s3_MT' num2str(d) '_on_T1_' sprintf('%05i',v1) '.nii,1'];
            end
            clear matlabbatch
            spm_jobman('initcfg')
            matlabbatch{1}.spm.util.cat.vols = list_task;
            matlabbatch{1}.spm.util.cat.name = ['coreg_s3_MT' num2str(d) '_on_T1.nii'];
            matlabbatch{1}.spm.util.cat.dtype = 4;
            spm_jobman('run',matlabbatch)
            
            movefile([path_parent num2str(IDs(id)) '_' num2str(d)  '/task3D/coreg_s3_MT' num2str(d) '_on_T1.nii'],...
                [path_parent num2str(IDs(id)) '_' num2str(d)  '/coreg_s3_MT' num2str(d) '_on_T1.nii'])
...
for id = 1:length(IDs)
    ...
    for d = 1:2
        ...
        if days(id,d) == 0
            ...
            Mask1   =[ path_ROIs num2str(IDs(id)) num2str(d) '/aparc+aseg_pt1_nat_labelled.nii'];
            
            % 4-D PET file
            PETflow = [path_parent num2str(IDs(id)) '_' num2str(days(id,d)) '/coreg_s3_InFlow' num2str(d) '_on_T1.nii'];
            ...
            [A B ROIDef]=xlsread('/Users/alex/Dropbox/paperwriting/MRPET/scripts/ExtractPETTACs/Dictionary_FSaparc2004_Desikan_ROIs.xls');
            maskidx=[];
            ...
            [A B ROIDef]=xlsread('/Users/alex/Dropbox/paperwriting/MRPET/scripts/ExtractPETTACs/Subcortical_Dictionary_2.xls');
            ...
            TACDATA.info = 'inFlow';
            mkdir(['/Users/alex/Dropbox/paperwriting/MRPET/data/TACs/Smoothed/' num2str(IDs(id)) num2str(d)])
            save([ '/Users/alex/Dropbox/paperwriting/MRPET/data/TACs/Smoothed/' num2str(IDs(id)) num2str(d) '/' num2str(IDs(id)) num2str(d) '_TACDATA_InFlow_s3.mat'],'TACDATA'); clear TACDATA DynPET temp ImgData            
        end
    end
end
...
for id = 1:length(IDs)
    ...
    for d = 1:2
        ...
        if days(id,d) == 0
            ...
            % Freesurfer segmentation, if .mgh use mri_read from FreeSurfer/Matlab
            clear Mask CurPET_task CurPET_flow CurPET_BSL
            Mask2   =[ path_ROIs num2str(IDs(id)) num2str(d) '/aparc+aseg_pt2_nat_labelled.nii'];
            
            % 4-D PET file
            PETtask = [path_parent num2str(IDs(id)) '_' num2str(days(id,d)) '/coreg_s3_MT' num2str(d) '_on_T1.nii'];
            PETbsl  = [path_parent num2str(IDs(id)) '_' num2str(days(id,d)) '/coreg_s3_Baseline' num2str(d) '_on_T1.nii'];
            ...
            save([ '/Users/alex/Dropbox/paperwriting/MRPET/data/TACs/Smoothed/' num2str(IDs(id)) num2str(d) '/' num2str(IDs(id)) num2str(d) '_TACDATA_Task_s3.mat'],'TACDATA'); clear TACDATA DynPET temp ImgData
...
%             save([ paths.TACs num2str(IDs(id)) num2str(d) '_TACDATA_InFlow.mat'],'TACDATA'); clear TACDATA DynPET temp ImgData
            ...
            save([ '/Users/alex/Dropbox/paperwriting/MRPET/data/TACs/Smoothed/' num2str(IDs(id)) num2str(d) '/' num2str(IDs(id)) num2str(d) '_TACDATA_Baseline_s3.mat'],'TACDATA'); clear TACDATA DynPET temp ImgData
        end
    end
end
...
for id = 1:length(IDs)
    ...
    for d = 1:2
        ...
        if days(id,d) == 0
            ...
            load([ '/Users/alex/Dropbox/paperwriting/MRPET/data/TACs/Smoothed/' num2str(IDs(id)) num2str(d) '/' num2str(IDs(id)) num2str(d) '_TACDATA_InFlow_s3.mat']);
            TACDATA_InFlow=TACDATA; clear TACDATA
            load([ '/Users/alex/Dropbox/paperwriting/MRPET/data/TACs/Smoothed/' num2str(IDs(id)) num2str(d) '/' num2str(IDs(id)) num2str(d) '_TACDATA_Baseline_s3.mat']);
            TACDATA_Baseline=TACDATA; clear TACDATA
            load([ '/Users/alex/Dropbox/paperwriting/MRPET/data/TACs/Smoothed/' num2str(IDs(id)) num2str(d) '/' num2str(IDs(id)) num2str(d) '_TACDATA_Task_s3.mat']);
            ...
            save(['/Users/alex/Dropbox/paperwriting/MRPET/data/TACs/Smoothed/' num2str(IDs(id)) num2str(d) '/' num2str(IDs(id)) num2str(d) '_TACs_deccorr_s3.mat'],'TACDATA_Baseline','TACDATA_InFlow','TACDATA_Task');
            ...
            try
                ...
                print('-dpdf','-bestfit',[ num2str(IDs(id)) num2str(d) '_smoothed_' date '.pdf']);
