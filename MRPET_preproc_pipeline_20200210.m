...
paths.preproc = [paths.parent 'E_data/EA_raw/EAD_PET/EADB_preprocessed/RewardTask2/'];
...
paths.TACs    = [paths.parent 'E_data/EA_raw/EAD_PET/EADC_TACs/RewardTask2/'];
...
for id = 1:length(IDs)
    ...
    for d = 1:2
        ...
        if days(id,d) == 0
            ...
            if (IDs(id) == 4007 || IDs(id) == 4004 ) && days(id,d) == 1
