...
%             end
            ...
            if fg_2_realigned == 0
                ...
                % PET inflow
                for cc = 1:length(spm_vol([paths.preproc num2str(IDs(id)) '_' num2str(days(id,d)) '/' num2str(IDs(id)) '_PET_4D_PET-InFlow_HD__AC_' num2str(days(id,d)) '.nii']))
                    flist_PETflow{cc,1}    = [paths.preproc num2str(IDs(id)) '_' num2str(days(id,d)) '/' num2str(IDs(id)) '_PET_4D_PET-InFlow_HD__AC_' num2str(days(id,d)) '.nii,' num2str(cc)];
                end;clear cc
                [config]        = preproc_realign_PET(IDs(id),flist_PETflow);
                [config]        = preproc_realign_estwrt_PET(IDs(id),flist_PETflow);
                
                % PET baseline
                for cc = 1:length(spm_vol([paths.preproc num2str(IDs(id)) '_' num2str(days(id,d)) '/' num2str(IDs(id)) '_PET_4D_PET-Baseline_HD__AC_' num2str(days(id,d)) '.nii']))
                    flist_PETbsl{cc,1}     = [paths.preproc num2str(IDs(id)) '_' num2str(days(id,d)) '/' num2str(IDs(id)) '_PET_4D_PET-Baseline_HD__AC_' num2str(days(id,d)) '.nii,' num2str(cc)];
                end;clear cc
            ...
            if fg_3_coregistered == 0
                ...
                PETflow_mean = cellstr([paths.preproc num2str(IDs(id)) '_' num2str(days(id,d)) '/mean' num2str(IDs(id)) '_PET_4D_PET-InFlow_HD__AC_' num2str(days(id,d)) '.nii']);
                PETbsl_mean  = cellstr([paths.preproc num2str(IDs(id)) '_' num2str(days(id,d)) '/mean' num2str(IDs(id)) '_PET_4D_PET-Baseline_HD__AC_' num2str(days(id,d)) '.nii']);
                for cc = 1:seriesnum
                ...
                for cc = 1:length(spm_vol([paths.preproc num2str(IDs(id)) '_' num2str(days(id,d)) '/' num2str(IDs(id)) '_PET_4D_PET-InFlow_HD__AC_' num2str(days(id,d)) '.nii']))
                    PETflow{cc,1}    = [paths.preproc num2str(IDs(id)) '_' num2str(days(id,d)) '/' num2str(IDs(id)) '_PET_4D_PET-InFlow_HD__AC_' num2str(days(id,d)) '.nii,' num2str(cc)];
                end;clear cc
                for cc = 1:length(spm_vol([paths.preproc num2str(IDs(id)) '_' num2str(days(id,d)) '/' num2str(IDs(id)) '_PET_4D_PET-Baseline_HD__AC_' num2str(days(id,d)) '.nii']))
                    PETbsl{cc,1}     = [paths.preproc num2str(IDs(id)) '_' num2str(days(id,d)) '/' num2str(IDs(id)) '_PET_4D_PET-Baseline_HD__AC_' num2str(days(id,d)) '.nii,' num2str(cc)];
                end;clear cc
...
for id = 1:length(IDs)
    ...
    for d = 1:2
        ...
        if days(id,d) == 0
            ...
            PETflow = [paths.preproc num2str(IDs(id)) '_' num2str(days(id,d)) '/c' num2str(IDs(id)) '_PET_4D_PET-InFlow_HD__AC_' num2str(days(id,d)) '.nii'];
            PETbsl  = [paths.preproc num2str(IDs(id)) '_' num2str(days(id,d)) '/c' num2str(IDs(id)) '_PET_4D_PET-Baseline_HD__AC_' num2str(days(id,d)) '.nii'];
