...
for id=2:length(ID)
    ...
    SN.pt1  = spm_read_vols(spm_vol(['/Users/alex/Documents/SN.nii']));
    SN.pt2  = spm_read_vols(spm_vol(['/Users/alex/Documents/SN.nii']));
    
    VTA.pt1 = spm_read_vols(spm_vol(['/Users/alex/Documents/VTA.nii']));
    VTA.pt2 = spm_read_vols(spm_vol(['/Users/alex/Documents/VTA.nii']));
    
    LC.pt1  = spm_read_vols(spm_vol(['/Users/alex/Documents/LC.nii']));
    LC.pt2  = spm_read_vols(spm_vol(['/Users/alex/Documents/LC.nii']));
    
    parc.pt1  = spm_read_vols(spm_vol(['/Volumes/ALEX3/MRPET/coreg_roi/' ID{id} '/aparc+aseg_on_MNI.nii']));
    parc.pt2  = spm_read_vols(spm_vol(['/Volumes/ALEX3/MRPET/coreg_roi/' ID{id} '/aparc+aseg_on_MNI.nii']));
    ...
    hdr = spm_vol(['/Users/alex/Documents/SN.nii']); % pick just any header from a file
    hdr.fname = ['/Volumes/ALEX3/MRPET/coreg_roi/' ID{id} '/data/SN_onMNI_labelled.nii'];
    hdr.dim = size(SN.pt1);
    ...
    hdr = spm_vol(['/Users/alex/Documents/SN.nii']); % pick just any header from a file
    hdr.fname = ['/Volumes/ALEX3/MRPET/coreg_roi/' ID{id} '/data/SN_onT1pt2_labelled.nii'];
    hdr.dim = size(SN.pt2);
    hdr = rmfield(hdr,'pinfo');
    ...
    hdr = spm_vol(['/Users/alex/Documents/VTA.nii']); % pick just any header from a file
    hdr.fname = ['/Volumes/ALEX3/MRPET/coreg_roi/' ID{id} '/data/VTA_onMNI_labelled.nii'];
    ...
    hdr = spm_vol(['/Users/alex/Documents/VTA.nii']); % pick just any header from a file
    hdr.fname = ['/Volumes/ALEX3/MRPET/coreg_roi/' ID{id} '/data/VTA_onT1pt2_labelled.nii'];
    ...
    hdr = spm_vol(['/Users/alex/Documents/LC.nii']); % pick just any header from a file
    hdr.fname = ['/Volumes/ALEX3/MRPET/coreg_roi/' ID{id} '/data/LC_onMNI_labelled.nii'];
    hdr.dim = size(LC.pt1);
    hdr = rmfield(hdr,'pinfo');
    ...
    hdr = spm_vol(['/Users/alex/Documents/LC.nii']); % pick just any header from a file
    hdr.fname = ['/Volumes/ALEX3/MRPET/coreg_roi/' ID{id} '/data/LC_onT1pt2_labelled.nii'];
    hdr.dim = size(LC.pt2);
    hdr = rmfield(hdr,'pinfo');
    ...
    clear hdr
    hdr = spm_vol(['/Volumes/ALEX3/MRPET/coreg_roi/' ID{id} '/aparc+aseg_on_MNI.nii']); % pick just any header from a file
    hdr.fname = ['/Volumes/ALEX3/MRPET/coreg_roi/' ID{id} '/aparc+aseg_on_MNI_labelled.nii'];
