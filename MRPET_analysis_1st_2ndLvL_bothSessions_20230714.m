...
% paths
paths = [];
paths.parent  = '/Users/yyi/Desktop/mrpet/';
...
setenv('PATH', [getenv('PATH') ':/usr/local/bin:/System/Cryptexes/App/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin']);
...
for id = 7:length(IDs)
    ...
    elseif sum(days(id,:))==1
    matlabbatch{1}.spm.stats.fmri_spec.sess.scans        = cellstr([paths.preproc num2str(IDs(id)) '/' ...
        'sua' num2str(IDs(id)) 'func1.nii']);
    elseif sum(days(id,:))==2
    matlabbatch{1}.spm.stats.fmri_spec.sess.scans        = cellstr([paths.preproc num2str(IDs(id)) '/' ...
        'sua' num2str(IDs(id)) 'func2.nii']);
    end
...
% paths
paths = [];
paths.parent  = '/Users/yyi/Desktop/mrpet/analysis/bothSessions/';
% paths.spm     = [paths.parent 'B_scripts/BE_toolboxes/spm12/'];
% paths.funx    = [paths.parent 'B_scripts/BB_analyses/BBC_MRI/analyses_functions/'];
% paths.preproc = [paths.parent 'E_data/EA_raw/EAD_PET/EADB_preprocessed/RewardTask/'];
paths.analyses= [paths.parent '1st/'];
paths.analyses_half = '/Users/yyi/Desktop/mrpet/analysis/eachSession/1st/';
paths.behav   = ['/Users/yyi/Desktop/mrpet/behav/'];
...
for c1 = 1:length(IDs_high)
    list_stim_highDA_reward_vs_neutral{c1,1} = [paths.analyses num2str(IDs_high(c1)) '/con_0001_mni.nii,1'];
end

list_stim_lowDA_reward_vs_neutral = []; cnt=0;
for c1 = 1:length(IDs_low)
    list_stim_lowDA_reward_vs_neutral{c1,1} = [paths.analyses num2str(IDs_low(c1)) '/con_0002_mni.nii,1'];
end
...
list_stim_rewardAll_vs_neutralAll_bothobly = [];
for c1 = 1:length(IDs_both)
    list_stim_rewardAll_vs_neutralAll_bothobly{c1,1} = [paths.analyses num2str(IDs_both(c1)) '/con_0003_mni.nii,1'];
end

list_fb_highDA_reward_vs_neutral = []; cnt=0;
for c1 = 1:length(IDs_high)
    list_fb_highDA_reward_vs_neutral{c1,1} = [paths.analyses num2str(IDs_high(c1)) '/con_0004_mni.nii,1'];
end

list_fb_lowDA_reward_vs_neutral = []; cnt=0;
for c1 = 1:length(IDs_low)
    list_fb_lowDA_reward_vs_neutral{c1,1} = [paths.analyses num2str(IDs_low(c1)) '/con_0005_mni.nii,1'];
end
...
list_fb_rewardAll_vs_neutralAll_bothonly = [];
for c1 = 1:length(IDs_both)
    list_fb_rewardAll_vs_neutralAll_bothonly{c1,1} = [paths.analyses num2str(IDs_both(c1)) '/con_0006_mni.nii,1'];
end
...
list_stim_Rewards_highDA_vs_lowDA_bothonly = [];
for c1 = 1:length(IDs_both)
    list_stim_Rewards_highDA_vs_lowDA_bothonly{c1,1} = [paths.analyses num2str(IDs_both(c1)) '/con_0007_mni.nii,1'];
end
...
list_fb_Rewards_highDA_vs_lowDA_bothonly = [];
for c1 = 1:length(IDs_both)
    list_fb_Rewards_highDA_vs_lowDA_bothonly{c1,1} = [paths.analyses num2str(IDs_both(c1)) '/con_0008_mni.nii,1'];
end
...
list_stim_Neutrals_highDA_vs_lowDA_bothonly = [];
for c1 = 1:length(IDs_both)
    list_stim_Neutrals_highDA_vs_lowDA_bothonly{c1,1} = [paths.analyses num2str(IDs_both(c1)) '/con_0009_mni.nii,1'];
end
...
list_fb_Neutrals_highDA_vs_lowDA_bothonly = [];
for c1 = 1:length(IDs_both)
    list_fb_Neutrals_highDA_vs_lowDA_bothonly{c1,1} = [paths.analyses num2str(IDs_both(c1)) '/con_0010_mni.nii,1'];
end
...
list_stim_highDA_vs_lowDA_bothonly = [];
for c1 = 1:length(IDs_both)
    list_stim_highDA_vs_lowDA_bothonly{c1,1} = [paths.analyses num2str(IDs_both(c1)) '/con_0011_mni.nii,1'];
end

list_fb_highDA_vs_lowDA_bothonly = [];
for c1 = 1:length(IDs_both)
    list_fb_highDA_vs_lowDA_bothonly{c1,1} = [paths.analyses num2str(IDs_both(c1)) '/con_0012_mni.nii,1'];
end
...
% ------- compute: stim_rewardAll_vs_neutralAll_bothobly bothonly ------- %
cd(paths.save2nd); mkdir('stim_rewardAll_vs_neutralAll_bothobly'); cd stim_rewardAll_vs_neutralAll_bothobly; dir_spm = pwd;
secondlvl_onesampleT(dir_spm,list_stim_rewardAll_vs_neutralAll_bothobly) % run
fMRI_estimate([dir_spm '/SPM.mat'])
clear matlabbatch
spm_jobman('initcfg');      % initiate job manager
matlabbatch{1}.spm.stats.con.spmmat = cellstr([dir_spm '/SPM.mat']);
matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'stim_rewardAll_vs_neutralAll_bothobly';
matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = 1;
matlabbatch{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{1}.spm.stats.con.delete = 1;    % 1 means delete, 0 means append
spm_jobman('run', matlabbatch) % run batch
...
% ------- compute: list_fb_rewardAll_vs_neutralAll_bothonly bothonly ------- %
cd(paths.save2nd); mkdir('fb_rewardAll_vs_neutralAll_bothonly'); cd fb_rewardAll_vs_neutralAll_bothonly; dir_spm = pwd;
secondlvl_onesampleT(dir_spm,list_fb_rewardAll_vs_neutralAll_bothonly) % run
fMRI_estimate([dir_spm '/SPM.mat'])
clear matlabbatch
spm_jobman('initcfg');      % initiate job manager
matlabbatch{1}.spm.stats.con.spmmat = cellstr([dir_spm '/SPM.mat']);
matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'fb_rewardAll_vs_neutralAll_bothonly';
matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = 1;
matlabbatch{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{1}.spm.stats.con.delete = 1;    % 1 means delete, 0 means append
spm_jobman('run', matlabbatch) % run batch
...
% ------- compute: list_stim_Rewards_highDA_vs_lowDA_bothonly bothonly ------- %
cd(paths.save2nd); mkdir('stim_Rewards_highDA_vs_lowDA_bothonly'); cd stim_Rewards_highDA_vs_lowDA_bothonly; dir_spm = pwd;
secondlvl_onesampleT(dir_spm,list_stim_Rewards_highDA_vs_lowDA_bothonly) % run
fMRI_estimate([dir_spm '/SPM.mat'])
clear matlabbatch
spm_jobman('initcfg');      % initiate job manager
matlabbatch{1}.spm.stats.con.spmmat = cellstr([dir_spm '/SPM.mat']);
matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'stim_Rewards_highDA_vs_lowDA_bothonly';
matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = 1;
matlabbatch{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{1}.spm.stats.con.delete = 1;    % 1 means delete, 0 means append
spm_jobman('run', matlabbatch) % run batch
...
% ------- compute: list_fb_Rewards_highDA_vs_lowDA_bothonly bothonly ------- %
cd(paths.save2nd); mkdir('fb_Rewards_highDA_vs_lowDA_bothonly'); cd fb_Rewards_highDA_vs_lowDA_bothonly; dir_spm = pwd;
secondlvl_onesampleT(dir_spm,list_fb_Rewards_highDA_vs_lowDA_bothonly) % run
fMRI_estimate([dir_spm '/SPM.mat'])
clear matlabbatch
spm_jobman('initcfg');      % initiate job manager
matlabbatch{1}.spm.stats.con.spmmat = cellstr([dir_spm '/SPM.mat']);
matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'fb_Rewards_highDA_vs_lowDA_bothonly';
matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = 1;
matlabbatch{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{1}.spm.stats.con.delete = 1;    % 1 means delete, 0 means append
spm_jobman('run', matlabbatch) % run batch
...
% ------- compute: list_stim_Neutrals_highDA_vs_lowDA_bothonly bothonly ------- %
cd(paths.save2nd); mkdir('stim_Neutrals_highDA_vs_lowDA_bothonly'); cd stim_Neutrals_highDA_vs_lowDA_bothonly; dir_spm = pwd;
secondlvl_onesampleT(dir_spm,list_stim_Neutrals_highDA_vs_lowDA_bothonly) % run
fMRI_estimate([dir_spm '/SPM.mat'])
clear matlabbatch
spm_jobman('initcfg');      % initiate job manager
matlabbatch{1}.spm.stats.con.spmmat = cellstr([dir_spm '/SPM.mat']);
matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'stim_Neutrals_highDA_vs_lowDA_bothonly';
matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = 1;
matlabbatch{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{1}.spm.stats.con.delete = 1;    % 1 means delete, 0 means append
spm_jobman('run', matlabbatch) % run batch
...
% ------- compute: list_fb_Neutrals_highDA_vs_lowDA_bothonly bothonly ------- %
cd(paths.save2nd); mkdir('fb_Neutrals_highDA_vs_lowDA_bothonly'); cd fb_Neutrals_highDA_vs_lowDA_bothonly; dir_spm = pwd;
secondlvl_onesampleT(dir_spm,list_fb_Neutrals_highDA_vs_lowDA_bothonly) % run
fMRI_estimate([dir_spm '/SPM.mat'])
clear matlabbatch
spm_jobman('initcfg');      % initiate job manager
matlabbatch{1}.spm.stats.con.spmmat = cellstr([dir_spm '/SPM.mat']);
matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'fb_Neutrals_highDA_vs_lowDA_bothonly';
matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = 1;
matlabbatch{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{1}.spm.stats.con.delete = 1;    % 1 means delete, 0 means append
spm_jobman('run', matlabbatch) % run batch
...
% ------- compute: list_stim_highDA_vs_lowDA_bothonly bothonly ------- %
cd(paths.save2nd); mkdir('stim_highDA_vs_lowDA_bothonly'); cd stim_highDA_vs_lowDA_bothonly; dir_spm = pwd;
secondlvl_onesampleT(dir_spm,list_stim_highDA_vs_lowDA_bothonly) % run
fMRI_estimate([dir_spm '/SPM.mat'])
clear matlabbatch
spm_jobman('initcfg');      % initiate job manager
matlabbatch{1}.spm.stats.con.spmmat = cellstr([dir_spm '/SPM.mat']);
matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'stim_highDA_vs_lowDA_bothonly';
matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = 1;
matlabbatch{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{1}.spm.stats.con.delete = 1;    % 1 means delete, 0 means append
spm_jobman('run', matlabbatch) % run batch
...
% ------- compute: list_fb_highDA_vs_lowDA_bothonly bothonly ------- %
cd(paths.save2nd); mkdir('fb_highDA_vs_lowDA_bothonly'); cd fb_highDA_vs_lowDA_bothonly; dir_spm = pwd;
secondlvl_onesampleT(dir_spm,list_fb_highDA_vs_lowDA_bothonly) % run
fMRI_estimate([dir_spm '/SPM.mat'])
clear matlabbatch
spm_jobman('initcfg');      % initiate job manager
matlabbatch{1}.spm.stats.con.spmmat = cellstr([dir_spm '/SPM.mat']);
matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'fb_highDA_vs_lowDA_bothonly';
matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = 1;
matlabbatch{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{1}.spm.stats.con.delete = 1;    % 1 means delete, 0 means append
spm_jobman('run', matlabbatch) % run batch
